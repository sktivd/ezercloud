...
e = Equipment.create(equipment: 'FREND', manufacturer: 'NanoEnTek', klass: 'Frend', db: 'frends', tests: 3, prefix: 'test')

a = AssayKit.create(equipment: 'FREND', manufacturer: "NanoEnTek", device: "PSA plus", kit: 30)
r = a.reagents.create(name: 'PSA (Total)', number: 30, unit: 'ng/mL', break_points:'0,1,5,10,15,25')
...
r = a.reagents.create(name: 'TSH', number: 40, unit: 'mIU/L', break_points:'0,1,5,10,15,25')
...
r = a.reagents.create(name: 'BNP', number: 19, unit: 'NA', break_points:'0,1,5,10,15,25')

a = AssayKit.create(equipment: 'FREND', manufacturer: 'NanoEnTek', device: 'Cardiac Triple', kit: 15)
r = a.reagents.create(name: 'Myoglobin', number: 14, unit: 'NA', break_points:'0,1,5,10,15,25')
r = a.reagents.create(name: 'Troponin I', number: 12, unit: 'NA', break_points:'0,1,5,10,15,25')
r = a.reagents.create(name: 'CK-MB', number: 13, unit: 'NA', break_points:'0,1,5,10,15,25')
