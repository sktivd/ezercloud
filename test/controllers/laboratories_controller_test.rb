...
class LaboratoriesControllerTest < ActionController::TestCase
  ...
  test "should create laboratory" do
    assert_difference('Laboratory.count') do
      post :create, laboratory: { equipment: @laboratory.equipment, ip_address: @laboratory.ip_address, reagent_number: @laboratory.reagent_number }
    end
  ...
  test "should update laboratory" do
    patch :update, id: @laboratory, laboratory: { equipment: @laboratory.equipment, ip_address: @laboratory.ip_address, reagent_number: @laboratory.reagent_number }
    assert_redirected_to laboratory_path(assigns(:laboratory))
  end
